...
function xmldb_qtype_postgresqlrunner_install() {
    ...
    try {
        ...
        require_once($CFG->dirroot . '/question/type/postgresqlrunner/classes/security/role_cleaner.php');
        \qtype_postgresqlrunner\security\role_cleaner::setup_scheduled_tasks();
