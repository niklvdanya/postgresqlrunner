...
class qtype_postgresqlrunner_edit_form extends question_edit_form {
    ...
    protected function definition_inner($mform) {
        ...
        $mform->addRule('expected_result', null, 'required', null, 'client');
    ...
    public function validation($data, $files) {
        ...
        if (!empty($data['expected_result'])) {
            ...
            if (!$this->is_valid_json($expected_result)) {
                $errors['expected_result'] = get_string('invalidjson', 'qtype_postgresqlrunner');
            }
        }
